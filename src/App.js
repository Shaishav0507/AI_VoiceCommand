      ...
      {!newsArticles.length ? (
        <div className={classes.footer}>
          <Typography variant="body1" component="h2">
            Created by
            <a className={classes.link} href="https://www.linkedin.com/in/shaishav-rastogi-8192971b7/"> Shaishav Rastogi</a> 
          </Typography>
        </div>
      ) : null}
    </div>
